...
# App header with gradient background - UPDATED WITH LARGER TEXT
st.markdown("""
<div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 5rem 2rem; border-radius: 0 0 40px 40px; margin-bottom: 3rem;">
    <div style="max-width: 1200px; margin: 0 auto;">
        ...
        <p class="sub-header" style="color: white; opacity: 0.9;">
            ...
            Powered by Your Custom-Trained AI Model
        </p>
...
if tokenizer and model:
    ...
    with col2:
        ...
        st.markdown('<p class="section-subtitle">Real-time sentiment analysis powered by your custom AI model.</p>', unsafe_allow_html=True)
        ...
        if analyze_clicked and review_text.strip():
            ...
            <div style="text-align: center; padding: 2rem;">
                ...
                <p style="font-size: 1.2rem;">Processing with your trained AI model...</p>
            </div>
            """):
                # Process the review
                ...
                # Detailed metrics - FIXED: Changed text color to dark
            ...
            <div style="background: rgba(59, 130, 246, 0.1); padding: 3.5rem 2rem; border-radius: 16px; border-left: 4px solid #3b82f6;">
                <div style="text-align: center;">
                    ...
                    <p style="margin: 0; color: #1e40af; font-size: 1.2rem;">Enter a movie review and click "Analyze Sentiment" to see detailed results from your custom AI model.</p>
                </div>
            </div>
            """, unsafe_allow_html=True)
    ...
    with features_col1:
        ...
        <div style="text-align: center; padding: 2rem 1rem;">
            ...
            <h4 class="feature-title">Custom AI Model</h4>
            <p class="feature-text">Powered by your specifically trained machine learning model for accurate movie review analysis</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    - The 'sentiment_model' folder exists in the same directory
    - It contains all required model files
    - You have a stable internet connection for first-time setup
    """)
